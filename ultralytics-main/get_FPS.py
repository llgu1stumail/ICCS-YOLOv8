...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/media/db306/e835eb80-e8ad-4728-8263-61e52cc524a1/gll/ultralytics-main/runs/train/yolov6n/weights/best.pt', help='trained weights path')
    ...
    parser.add_argument('--warmup', default=700, type=int, help='warmup time')
