...
def get_params():
    params = {
        'weight': '/media/db306/e835eb80-e8ad-4728-8263-61e52cc524a1/gll/ultralytics-main/runs/train/3yolov8-C2f-SMPCGLU-CSP-PTB-ReCalibraP2345-LSCD-F/weights/best.pt',
        # 'weight': '/media/db306/e835eb80-e8ad-4728-8263-61e52cc524a1/gll/ultralytics-main/runs/train/yolov87/weights/best.pt',
...
if __name__ == '__main__':
    ...
    # model(r'/media/db306/e835eb80-e8ad-4728-8263-61e52cc524a1/gll/slab8/Images/178.png', 'result')
    model(r'/media/db306/e835eb80-e8ad-4728-8263-61e52cc524a1/gll/slab8/datasets/images/test', 'result5')